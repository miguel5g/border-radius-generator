$(document).ready(() => {
  ...
  function getValues() {
    ...
    rTValue =
      rTValue.join("") === ""
        ? "0"
        : Number(rTValue.join("")) > 200
        ? "200"
        : rTValue.join("");
    rBValue =
      rBValue.join("") === ""
        ? "0"
        : Number(rBValue.join("")) > 200
        ? "200"
        : rBValue.join("");
    lTValue =
      lTValue.join("") === ""
        ? "0"
        : Number(lTValue.join("")) > 200
        ? "200"
        : lTValue.join("");
    lBValue =
      lBValue.join("") === ""
        ? "0"
        : Number(lBValue.join("")) > 200
        ? "200"
        : lBValue.join("");
...
<div>-webkit-border-radius: ${newBorder};</div>
  ...
  function copyResults() {
    ...
    navigator.clipboard.writeText(
      `border-radius: ${newBorder};\n-moz-border-radius: ${newBorder};\n-webkit-border-radius: ${newBorder};`
    );
  }
});
